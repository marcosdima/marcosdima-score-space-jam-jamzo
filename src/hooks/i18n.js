  ...
  en: {
    ...
    game: {
      ...
      labels: {
        ...
        mission: 'Mission',
        resources: 'Resources',
        revival_selection: 'Revival Selection',
        available_worlds: 'Available Worlds',
        available_souls: 'Available Souls',
        no_worlds_available: 'No worlds available for revival.',
        all_simulations_finished: 'All simulations have finished!',
      },
    },
    leaderboard: {
      title: 'Leaderboard',
  ...
  es: {
    ...
    game: {
      ...
      labels: {
        ...
        mission: 'Misión',
        resources: 'Recursos',
        revival_selection: 'Selección de Avivamiento',
        available_worlds: 'Mundos Disponibles',
        available_souls: 'Almas Disponibles',
        no_worlds_available: 'No hay mundos disponibles para avivar.',
        all_simulations_finished: '¡Todas las simulaciones han terminado!',
      },
    },
    leaderboard: {
